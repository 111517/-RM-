...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'myweight/weights/best.pt', help='weights path')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[256, 320], help='image (h, w)')
