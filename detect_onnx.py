...
if __name__ == "__main__":
    ...
    parser.add_argument("--imgpath", type=str, default='0', help="image path")
    parser.add_argument('--net_type', default='myweight/weights/last_best.onnx', choices=['yolov5s', 'yolov5l', 'yolov5m', 'yolov5x'])
