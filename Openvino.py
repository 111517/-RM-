...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default=r'D:\cv\yolov5-lite-onnxruntime-main\imgs\bus.jpg',
                        help="image path")
    parser.add_argument('--modelpath', type=str, default=r'D:\cv\yolov5-lite-onnxruntime-main\onnxmodel\v5lite-g.onnx',
                        help="onnx filepath")
    parser.add_argument('--classfile', type=str, default='D:\cv\yolov5-lite-onnxruntime-main\imgs\coco.names',
