            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        img_points = [[x1,y1],[x2,y1],[x1,y2],[x2,y2]]  # 存储2D点
                        ...
                        Camera_intrinsic = {"mtx": mtx, "dist": dist, }
                        #rvec_matrix = np.array([[ 0.59145205, -0.00465524 , 0.80632674],[-0.05093781 ,-0.99820175 , 0.03160059],[ 0.80472966, -0.05976275, -0.5906256 ]])
                        #tvec = np.array([[ 3.93251801],[-1.25883372],[21.29581439]])
                        ...
                        yy=(y1+y2)//2
                        kf = KalmanFilter()
                        cv2.circle(im0, (xx,yy), 15, (0, 20, 220), -1)
                        predicted = kf.predict(xx,yy)
                        print(predicted)
                        cv2.circle(im0, predicted, 15, (20, 220, 0), 4)
